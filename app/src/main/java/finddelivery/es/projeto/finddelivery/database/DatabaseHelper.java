...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE estabelecimento (restaurante VARCHAR( 20 ) NOT NULL, endereco( 50 ), especialidade VARCHAR( 20 ), horario_de_funcionamento VARCHAR( 50 ), phone1 VARCHAR( 15 ), phone2 VARCHAR( 15 ), logo VARBINARY( 100 ));");
    }
